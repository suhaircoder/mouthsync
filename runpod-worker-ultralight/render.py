"""Render implementation for backend ultralight — replace scaffold with upstream inference."""

from __future__ import annotations

BACKEND_ID = "ultralight"
BACKEND_READY = False
UPSTREAM_REPO = "https://github.com/anliyuan/Ultralight-Digital-Human"
