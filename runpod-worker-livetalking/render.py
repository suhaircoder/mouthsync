"""Render implementation for backend livetalking — replace scaffold with upstream inference."""

from __future__ import annotations

BACKEND_ID = "livetalking"
BACKEND_READY = False
UPSTREAM_REPO = "https://github.com/lipku/LiveTalking"
